require('dap').configurations.java = {
  {
    javaExec = "~/dev/easy-poker/target/easy-poker-1.0-SNAPSHOT.jar",
    mainClass = "com.easycode.App",
  },
}

vim.keymap.set('n', '<leader><C-b>', function() require('dap').continue() end)
...
vim.keymap.set('n', '<leader>se', function() require('dap').step_out() end)
